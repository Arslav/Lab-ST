...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>Возраст: <asp:textbox runat="server" id="age" style="margin-left: 41px" Width="173px" AutoPostBack="True"></asp:textbox></p>
    <p>Место работы: <asp:textbox runat="server" id="work" Width="173px" AutoPostBack="True" OnTextChanged="work_TextChanged"></asp:textbox></p>
